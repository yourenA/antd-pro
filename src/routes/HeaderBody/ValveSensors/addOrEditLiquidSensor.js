      ...
      <div>
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem
            style={{width: '50%', display: 'inline-block'}}
            {...formItemLayoutWithLabel}
            label= {formatMessage({id: 'intl.valve_sensors_index'})}
          >
            {getFieldDecorator('index', {
              initialValue: this.props.editRecord ? this.props.editRecord.index : '',
              rules: [{required: true, message:  formatMessage({id: 'intl.valve_sensors_index'})+formatMessage({id: 'intl.can_not_be_empty'})}],
            })(
              <InputNumber min={1}/>
            )}
          </FormItem>
          ...
          <FormItem
            ...
            label={(
              <span>
              {formatMessage({id: 'intl.level_valve_control_threshold_value'})}
            </span>
            )}
          >
            {getFieldDecorator('thresholds', {
              initialValue: this.props.editRecord ? this.props.editRecord.thresholds : '',
              rules: [{required: true, message:  formatMessage({id: 'intl.level_valve_control_threshold_value'})+formatMessage({id: 'intl.can_not_be_empty'})}],
          ...
          <FormItem
            style={{width: '50%', display: 'inline-block'}}
            {...formItemLayoutWithLabel}
            label= {formatMessage({id: 'intl.positive/negative_feedback'})}
          >
            {getFieldDecorator('is_positive_feedback', {
              ...
              rules: [{required: true, message:  formatMessage({id: 'intl.positive/negative_feedback'})+formatMessage({id: 'intl.can_not_be_empty'})}],
            })(
              <RadioGroup>
                <Radio value="1">{formatMessage({id: 'intl.positive_feedback'})}</Radio>
                <Radio value="-1">{formatMessage({id: 'intl.negative_feedback'})}</Radio>
              </RadioGroup>
            )}
          </FormItem>
          <FormItem
            style={{width: '50%', display: 'inline-block'}}
            {...formItemLayoutWithLabel}
            label= {formatMessage({id: 'intl.is_automatic_linkage'})}
          >
            {getFieldDecorator('is_automatic_linkage', {
              ...
              rules: [{required: true, message:  formatMessage({id: 'intl.is_automatic_linkage'})+formatMessage({id: 'intl.can_not_be_empty'})}],
            })(
              <RadioGroup>
                <Radio value="1"> {formatMessage({id: 'intl.yes'})}</Radio>
                <Radio value="-1"> {formatMessage({id: 'intl.no'})}</Radio>
              </RadioGroup>
            )}
          </FormItem>
          <FormItem
